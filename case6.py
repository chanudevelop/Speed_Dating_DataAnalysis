...
import evaluation_analysis_for_Label
import LabelEncoding_MinMax

# Case 6 - LabelEncoding & MinMax & K = 5
if __name__ == '__main__':
    ...
    # preprocess data
    not_scaled_preprocessed_data, preprocessed_data = LabelEncoding_MinMax.Label_MinMax(df)
    ...
    evaluation_analysis_for_Label.evaluate_and_analyze(preprocessed_data)

    # compare test data with original data
    # print results as commercial statement
    evaluation_analysis_for_Label.compare_test_data_with_cluster_data(preprocessed_data, evaluation_analysis_for_Label.test_data, not_scaled_preprocessed_data)
